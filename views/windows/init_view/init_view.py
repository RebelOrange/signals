...
class init_view(QWidget):
    ...
    def _init_entry_layout(self, main_layout: QVBoxLayout):
        # --- Group 1: General & Antenna Settings ---
        grp_antenna = QGroupBox("Antenna & Target Setup")
        ...
        form_antenna.addRow("Target On:", self.chk_tgt_on)
        form_antenna.addRow("Number of Elements:", self.spin_elements)
