...
PACKAGE_MAPPING = {
    ...
    "b2xx_fw": {
        ...
        "files": ["usrp_b200_fw.hex", "usrp_b200_bl.img"],
    },
    "b100": {
        "type": "usrp1",
        "package_name": "usrp1_b100_fpga_default-g{}.zip",
        "files": ["usrp_b100_fpga_2rx.bin", "usrp_b100_fpga.bin"],
    },
    "b100_fw": {
        "type": "usrp1",
    ...
    "usrp1": {
        ...
        "files": ["usrp1_fpga_4rx.rbf", "usrp1_fpga.rbf", "usrp1_fw.ihx"],
    },
    "octoclock": {
        "type": "octoclock",
        "package_name": "octoclock_octoclock_fw_default-g{}.zip",
        "files": ["octoclock_bootloader.hex", "octoclock_r4_fw.hex"],
    },
    "winusb_drv": {
        "type": "usb",
        ...
        "files": [
            "winusb_driver/",
            "winusb_driver/erllc_uhd_ni29xx.inf",
            "winusb_driver/erllc_uhd_b206mini.inf",
